...
| Approach document | `doc/APPROACH_DOCUMENT.md`: problem, solution, architecture, design decisions, performance |
| Requirements mapping | This file: `doc/REQUIREMENTS.md` |
